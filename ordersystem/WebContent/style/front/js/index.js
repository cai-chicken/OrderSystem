...
$(function(e) {
	...
	$('ol li').click(function(e) {
		...
		$("#menuImg"+$(this).index()).siblings().hide();
		$("#menuImg"+$(this).index()).show();
		/*
		 * $('.banner ul li a:first
		 * img').attr('src','img/'+$(this).index()+'.jpg').hide().fadeIn(600)
		 */
	});
	...
	$('.leftBtn').click(
		function(e) {
			...
			$("#menuImg"+num).siblings().hide();
			$("#menuImg"+num).show();
			/*$('.banner ul li a:first img').attr('src',
					'img/' + num + '.jpg').hide().fadeIn(300);*/
			$('ol li').eq(num).addClass('current').siblings().removeClass('current');
		});
