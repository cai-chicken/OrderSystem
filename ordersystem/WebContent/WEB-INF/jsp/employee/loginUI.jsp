...
.u_logo {
	background: url("${pageContext.request.contextPath}/style/Images/username.png") no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 43px;
	left: 40px;
...
.p_logo {
	background: url("${pageContext.request.contextPath}/style/Images/password.png") no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 12px;
	left: 40px;
...
.tou {
	background: url("${pageContext.request.contextPath}/style/Images/tou.png") no-repeat;
	width: 97px;
	height: 92px;
	position: absolute;
	top: -87px;
...
.left_hand {
	background: url("${pageContext.request.contextPath}/style/Images/left_hand.png") no-repeat;
	width: 32px;
	height: 37px;
	position: absolute;
	top: -38px;
...
.right_hand {
	background: url("${pageContext.request.contextPath}/style/Images/right_hand.png") no-repeat;
	width: 32px;
	height: 37px;
	position: absolute;
	top: -38px;
...
.initial_left_hand {
	background: url("${pageContext.request.contextPath}/style/Images/hand.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -12px;
...
.left_handing {
	background: url("${pageContext.request.contextPath}/style/Images/left-handing.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -24px;
...
.right_handinging {
	background: url("${pageContext.request.contextPath}/style/Images/right_handing.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -21px;
