...
public class StoreAction extends ModelDrivenBaseAction<Store> {
	...
	public String list() throws Exception {
		...
		new QueryHelper(Store.class, "s")//
			.addOrderProperty("s.use", false)//按是否启用降序
	...
	public String edit() throws Exception {
		...
		store.setUse(model.getUse());
		//TODO
		store.setImage(model.getImage());
		// 3、更新到数据库中
	 ...
	 * @throws Exception
	 */
	public String changeUseState() throws Exception{
		//将原来状态为1的本店记录修改为0
		Store oldStore = storeService.findByUseState();
		oldStore.setUse("0");
