...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="applicationTemplate_%{id == null?'add':'edit'}" 
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        <td>所用流程</td>
                        <td><s:select cssClass="SelectStyle" name="processDefinitionKey"
                        	list="#processDefinitionList" listKey="key" listValue="name"/>
								*
						</td>
                    </tr>
                </table>
