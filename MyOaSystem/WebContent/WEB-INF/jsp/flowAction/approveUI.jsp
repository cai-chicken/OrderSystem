...
<div id=MainArea>
    ...
    <s:hidden name="approval" value="true"/>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><s:a action="applicationTemplate_download?id=%{applicationTemplateId}" cssStyle="text-decoration: underline">[点击下载申请的文档]</s:a></td>
					</tr>
                </table>
            </div>
        </div>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        <td>请选择下一步</td>
                        <td>
                        	<s:select name="outcomes" list="#outcomes"/>
                        </td>
                    </tr>
                    </s:if>
                </table>
